    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      ...
      <div class="collapse navbar-collapse" id="navbarNavDropdown">
        <ul class="navbar-nav ml-lg">
          ...
          <li class="nav-item">
            <a class="nav-link" href="ver_alumnos.php"><i class="fas solid fa-child"></i> Datos de alumnos</a>
          </li>
          <li class="nav-item">
          ...
          if($result -> num_rows > 0){ 
            while($row = $result ->fetch_assoc()){
              echo "<tr>
                  ...
                  <td class=text-center>".$row['apellido_paterno']."</td>
                  <td class=text-center>".$row['apellido_materno']."</td>
                  <td class=text-center>".$row['nombre']."</td>
                  <td class=text-center>".$row['curp']."</td>
                  <td class=text-center>".$row['promedio_primaria']."</td>
                  <td class=text-center>".$row['certificado']."</td>
                  <td class=text-center>".$row['fecha_registro']."</td>
                  <td class=text-center>
                    <a href='eliminar_alumno.php?FOLIO=".$row['FOLIO']."'><button type='button' style=background-color:red;><strong>Eliminar</strong></button></a>
                    <a href='actualizar_alumno.php?FOLIO=".$row['FOLIO']."'><button type='button' style=background-color:green;><strong>Editar</strong></button></a>
                  </td>   
                </tr>";
            }
          } else{
