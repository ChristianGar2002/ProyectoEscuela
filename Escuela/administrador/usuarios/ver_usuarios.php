    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      ...
      <div class="collapse navbar-collapse" id="navbarNavDropdown">
        <ul class="navbar-nav ml-lg">
          ...
          <li class="nav-item">
            <a class="nav-link" href="ver_usuarios.php"><i class="fas fa-search"></i> Consultar_Usuarios</a>
          </li>
          <?php } ?>
            ...
            while($row = $result ->fetch_assoc()){
              echo "<tr>
                  ...
                  <td class=text-center>
                    <a href='eliminar_usuario.php?id=".$row['id']."'><button type='button' style=background-color:red;><strong>Eliminar</strong></button></a>
                    <a href='actualizar_usuarios.php?id=".$row['id']."'><button type='button' style=background-color:green;><strong>Editar</strong></button></a>
                  </td>   
                </tr>";
            }
          } else{
