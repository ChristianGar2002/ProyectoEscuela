...
<html lang="en">
  <head>
    ...
    <title>Actualizar Preinscripción</title>
  </head>
  <body>
    <!-- Inicio del menu -->
            ...
            <div class="row">
              <div class="col-md-12">
                  <form method="POST" style="width: 340px;border:1px solid white;margin-right: auto;margin-left: auto;" >
                    <h2 class="text-uppercase mt-3 font-weight-bold text-white text-center">Ingresar la CURP de su hijo(a)</h2>
                    ...
                    <div class="row">
                      <div class="col-lg-12">
                        <div class="form-group">
                          <label class="font-weight-bold text-white">Escriba la curp:</label>
                          <input type="text" name="dato" class="form-control mt-2" placeholder="CURP" required>
                        </div>
                      </div>
                      <div class="col-lg-12">
                        <div class="form-group">
                      ...
                      <div class="col-lg-12">
                        <button class="btn btn-primary btn-block" type="submit" name="Enviar" value="Buscar">Buscar</button>
                      </div>
                    </div>
                  </form>
              </div>
    ...
    <footer class="footer" style="width: 100%;">
        <div class="container"style="width: 100%;">
          ...
          <div class="footer text-white" style="padding-left: 20px;width: 100%;">
