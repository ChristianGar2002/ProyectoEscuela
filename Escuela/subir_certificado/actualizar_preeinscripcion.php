<?php
  ...
  if (isset($_POST['Enviar'])) {
    ...
    $sql= "SELECT * FROM formulario1 WHERE curp = '{$dato}'";
    $result= $conex->query($sql);
    
    $data= $result->fetch_assoc();
    if(mysqli_num_rows($result) == 0){
    echo '<script language="javascript">alert("Este registro no existe");window.location.href="acceder_datos.php"</script>'; 
}
        ...
        <div class="row" id="cita" style="margin-right: auto; margin-left: auto;">
            <div class="row" style="margin-right: auto; margin-left: auto;">
              <div class="col-md-12 mx-auto">
                  <form action="actualizar_preeinscripcion2.php" method="POST">
                    <h2 class="text-uppercase mt-3 font-weight-bold text-white text-center">Actualiza tus datos</h2>
                    <div class="row">
                      <div class="col-lg-4">
                      ...
                      <div class="col-lg-4">
                        <div class="form-group">
                          ...
                          <input type="text" name="nacionalidad" class="form-control mt-2" placeholder="Nacionalidad" value="<?php echo $data['nacionalidad']?>" required>
                        </div>
                      </div>
                      <div class="col-lg-4">
                        <div class="form-group">
                          <label class="font-weight-bold text-white">Primaria de estudio:</label>
                          <input type="text" name="primaria_estudio" class="form-control mt-2" placeholder="Nombre de la primaria" value="<?php echo $data['primaria_estudio']?>" required>
                        </div>
                      </div>
                      <div class="col-lg-4">
                        <div class="form-group">
                          <label class="font-weight-bold text-white">Telefono del alumno:</label>
                          <input type="text" name="telefono_alumno" class="form-control mt-2" placeholder="WhastApp" value="<?php echo $data['telefono_alumno']?>">
                        </div>
                      </div>
                      <div class="col-lg-4">
                        <div class="form-group">
                          <label class="font-weight-bold text-white">Discapacidad:</label>
                          <input type="text" name="discapacidad" class="form-control mt-2" placeholder="Discapacidad del alumno" value="<?php echo $data['discapacidad']?>">
                        </div>
                      </div>
                      <div class="col-lg-4">
                        <div class="form-group">
                      ...
                      <div class="col-lg-12">
                        <div class="form-group">
                          ...
                          <textarea class="form-control" id="exampleFomrControlTextarea1" name="tienes_hermanos" placeholder="¿Tienes hermanos aquí en la Escuela Secundaria Quetzalcóatl? Anótalo grado y grupo" cols="3" value="<?php echo $data['tienes_hermanos']?>"></textarea>
                        </div>
                      </div>
                      <div class="col-lg-12">
                        <div class="form-group">
                      ...
                      <div class="col-lg-4">
                        ...
                        <div class="col-lg-4">
                          <div class="form-group">
                            ...
                            <input type="text" name="estado" class="form-control mt-2" placeholder="Estado" value="<?php echo $data['estado']?>" required>
                          </div>
                        </div>
                        <div class="col-lg-4">
                          <div class="form-group">
                            <label class="font-weight-bold text-white">Correo electronico:</label>
                            <input type="email" name="correo" class="form-control mt-2" placeholder="Email" value="<?php echo $data['correo']?>" required>
                          </div>
                        </div>
                        <div class="col-lg-4">
                          <div class="form-group">
                        ...
                        <div class="col-lg-4">
                          <div class="form-group">
                            ...
                            <input type="number" name="telefono_familiar" class="form-control mt-2" placeholder="Teléfono del familiar" value="<?php echo $data['telefono_familiar']?>">
                          </div>
                        </div>
                        <div class="col-lg-4">
                          <div class="form-group">
                            <label class="font-weight-bold text-white">Selecciona la primer carrera:</label>
                            <select name="carrera_1" id="servicio" class="form-control mt-2" required>
                        ...
                        <div class="col-lg-4">
                          <div class="form-group">
                            ...
                            <select name="carrera_2" id="servicio" class="form-control mt-2" required>
                              <option>Carreras:</option>
                              <option>Taller de informatica (Computación)</option>
                              <option>Taller de diseño y creación plástica(Pintura)</option>
                              <option>Taller de electrónica, comunicación y sistemas de control (Electrónica)</option>
                        ...
                        <div class="col-lg-4">
                          <div class="form-group">
                            ...
                            <select name="carrera_3" id="servicio" class="form-control mt-2" required>
                              <option>Carreras:</option>
                              <option>Taller de informatica (Computación)</option>
                              <option>Taller de diseño y creación plástica(Pintura)</option>
                              <option>Taller de electrónica, comunicación y sistemas de control (Electrónica)</option>
                        ...
                        <div class="col-lg-4">
                          <div class="form-group">
                            ...
                            <select name="carrera_4" id="servicio" class="form-control mt-2" required>
                              <option>Carreras:</option>
                              <option>Taller de informatica (Computación)</option>
                              <option>Taller de diseño y creación plástica(Pintura)</option>
                              <option>Taller de electrónica, comunicación y sistemas de control (Electrónica)</option>
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                          <input type="hidden" name="dato" value="<?php echo $data['curp']?>"/>
                        </div>
                      </div>
                      <div class="col-lg-8" style="margin-right: auto; margin-left: auto;">
                        <button class="btn btn-success btn-block" type="submit" name="Enviar" value="Enviar">Actualizar</button>
                      </div>
                      <div class="col-lg-8" style="margin-right: auto; margin-left: auto;">
                        <a href="acceder_datos.php"><button class="btn btn-primary btn-block" type="button" value="Regresar">Regresar</button></a>
                     </div>
                     <div class="col-lg-8" style="margin-right: auto; margin-left: auto;">
                        <a href="../administrador/dashboard/PDF/crear_pdf_alumno.php?FOLIO=<?php echo $data['FOLIO']; ?>"><button class="btn btn-warning btn-block" type="button" value="PDF">PDF</button></a>
                     </div>
                    </div>
                  </form>
              </div>
