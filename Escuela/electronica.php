   ...
   <!-- Inicio del menu -->
    ...
    <div class="container-fluid">
      <div class="jumbotron mt-4 animate__bounceIn">
        <h1 class="display text-center" style="margin-top: -20px;">Taller de electrónica, comunicación y sistemas de control (Electrónica)</h1>
         <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="img/electronica/electronica.jpg" class="d-block w-100" width="370" height="450" alt="Foto 1">
            </div>
            <div class="carousel-item">
              <img src="img/electronica/electronica2.jpg" class="d-block w-100" width="370" height="450" alt="Foto 2">
            </div>
            <div class="carousel-item">
              <img src="img/electronica/electronica3.jpg" class="d-block w-100" width="370" height="450" alt="Foto 3">
            </div>
            <div class="carousel-item">
              <img src="img/electronica/electronica4.jpg" class="d-block w-100" width="370" height="450" alt="Foto 4">
            </div>
          </div>
        ...
        <h2 class="display text-left">Finalidad del Taller</h2>
          <p class="lead text-justify">La finalidad del taller es dar el primer acercamiento a los estudiantes al fascinante mundo de los circuitos electronicos, la base de la tecnologia digital con la que se fabrican los microprocesadores que han revolucionado el mundo entero en las ultimas decadas.</p>
        <h4>Objetivo</h4>
          <p class="lead text-justify">El objetivo de este taller consiste en presentar al estudiante las caracteristicas, aplicaciones y comportamiento de los componentes electronicos que conforman un circuito resistores, condensadores, diodos, transistores, etc., asi como la combinacion de materiales y energia que hacen posible el funcionamiento de todos los dispositivos digitales y electronicos que utilizamos a diario. </p>
      </div>
    </div>
    <!-- Fin de contenidos -->
