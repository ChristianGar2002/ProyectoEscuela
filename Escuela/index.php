    ...
    <div class="container-fluid py-4">
        <div class="row" id="cita">
          <div class="container">
            <div class="row">
              <div class="col-md-12">
                  <h2 class="text-uppercase font-weight-bold text-dark text-center">Bienvenidos al sistema de preinscripción de la escuela secundaria QUETZALCOALT</h2>
                  <form method="" style="width: 340px;border:1px solid white;margin-right: auto;margin-left: auto;">
                    <h2 class="text-uppercase mt-3 font-weight-bold text-white text-center">Seleccione una opción</h2>
                    ...
                    <div class="row">
                      <div class="col-lg-12">
                        <div class="form-group">
                          <a href="subir_certificado/acceder_datos.php"><input type="button" class="form-control mt-2" value="Quiero revisar datos" style="background-color: greenyellow;font-size: 18px;"></a>
                        </div>
                      </div>
                      <div class="col-lg-12">
                        <div class="form-group">
                          <a href="preeinscripcion/preeinscripcion.php"><input type="button" class="form-control mt-2" value="Realizar preinscripción" style="background-color: skyblue;font-size: 18px;"></a>
                        </div>
                      </div>
                      <div class="col-lg-12" style="margin-left: auto;margin-right: auto;">
                        <div class="form-group">
                          <a href="login/sesion_admin.php"><input type="button" class="form-control mt-2" value="Soy un administrador"style="font-size: 18px;"></a>
                        </div>
                      </div>
                    </div>
                  </form>
            ...
            <div class="footer-col">
             ...
             <div class="footer-col">
              ...
              <div class="social-links">
                <a href="https://www.facebook.com/SecundariaGeneralQuetzalcoatl/"><i class="fab fa-facebook-f"></i></a>
