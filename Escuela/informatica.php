   ...
   <!-- Inicio del menu -->
    ...
    <div class="container-fluid">
      <div class="jumbotron mt-4 animate__bounceIn">
        <h1 class="display text-center" style="margin-top: -20px;">Taller de informatica (Computación)</h1>
         <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="img/informatica/computacion.jpg" class="d-block w-100" width="370" height="450" alt="Foto 1">
            </div>
            <div class="carousel-item">
              <img src="img/informatica/computacion2.jpg" class="d-block w-100" width="370" height="450" alt="Foto 2">
            </div>
            <div class="carousel-item">
              <img src="img/informatica/computacion3.jpg" class="d-block w-100" width="370" height="450" alt="Foto 3">
            </div>
            <div class="carousel-item">
              <img src="img/informatica/computacion4.jpg" class="d-block w-100" width="370" height="450" alt="Foto 4">
            </div>
          </div>
        ...
        <h2 class="display text-left">Finalidad del Taller</h2>
          <p class="lead text-justify">Este taller pretende introducir a las personas interesadas en el fascinante universo de la informática. De forma divertida y práctica, irán adquiriendo habilidad y experiencia en el uso del ordenador y se familiarizarán con los programas que más se adecuan a su edad e intereses.</p>
          <p class="lead text-justify">Esta introducción a las nuevas tecnologías sentará una sólida base en el niño que le permitirá, desde pequeño, desenvolverse con soltura en el mundo de la informática.</p>
        <h4>Objetivo</h4>
          <p class="lead text-justify">El objetivo prioritario de estas clases es preparar al niño en el uso de las principales aplicaciones informáticas sobre procesadores de textos, bases de datos, hojas de cálculo, presentaciones gráficas... con el objetivo prioritario de que facilite la máxima comprensión y organización de cara a sus estudios.</p>
      </div>
    </div>
    <!-- Fin de contenidos -->
