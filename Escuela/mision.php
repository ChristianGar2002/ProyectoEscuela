   ...
   <!-- Inicio del menu -->
    ...
    <div class="container-fluid">
      <div class="jumbotron mt-4 animate__bounceIn">
        <h1 class="display text-center" style="margin-top: -20px;">Misión de la escuela Quetzaltcoalt</h1>
        ...
        <br>
        <h2 class="display text-left">Misión</h2>
          <p class="lead text-justify">En esta escuela se trabaja de manera colaborativa con el firme propósito de definir competencias y orientar el hacer cotidiano de los educandos para que se apropien de los conocimientos significativos tendientes al desarrollo de habilidades, y al mismo tiempo les sirvan para construir y practicar los valores elementales y adquieran una actitud que les permita progresar de manera personal, familiar y como consecuencia de la sociedad en que vive.
          </p>
      </div>
    </div>
    <!-- Fin de contenidos -->
