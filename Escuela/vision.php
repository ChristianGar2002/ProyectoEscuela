   ...
   <!-- Inicio del menu -->
    ...
    <div class="container-fluid">
      <div class="jumbotron mt-4 animate__bounceIn">
        <h1 class="display text-center" style="margin-top: -20px;">Visión de la escuela Quetzaltcoalt</h1>
        ...
        <br>
        <h2 class="display text-left">Visión</h2>
          <p class="lead text-justify">Formar hombres críticos, analíticos y reflexivos, para que su convivencia este acorde con las controversias que surjan en la sociedad para que se conviertan en ciudadanos que practiquen los valores y alcancen una vida de calidad.
          </p>
      </div>
    </div>
    <!-- Fin de contenidos -->
