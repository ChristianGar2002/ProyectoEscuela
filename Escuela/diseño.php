   ...
   <!-- Inicio del menu -->
    ...
    <div class="container-fluid">
      <div class="jumbotron mt-4 animate__bounceIn">
        <h1 class="display text-center" style="margin-top: -20px;">Taller de diseño y creación plástica (Pintura)</h1>
         <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="img/diseño/diseño.jpg" class="d-block w-100" width="370" height="450" alt="Foto 1">
            </div>
            <div class="carousel-item">
              <img src="img/diseño/diseño2.jpg" class="d-block w-100" width="370" height="450" alt="Foto 2">
            </div>
            <div class="carousel-item">
              <img src="img/diseño/diseño3.jpg" class="d-block w-100" width="370" height="450" alt="Foto 3">
            </div>
            <div class="carousel-item">
              <img src="img/diseño/diseño4.jpg" class="d-block w-100" width="370" height="450" alt="Foto 4">
            </div>
          </div>
        ...
        <h2 class="display text-left">Finalidad del Taller</h2>
          <p class="lead text-justify">El taller está enfocado para los alumnos que están interesados en desarrollar habilidades en el
          área práctica de las artes plásticas y visuales. </p>
          <p class="lead text-justify">El taller pretende ayudar a desarrollar y a formar los procesos creativos derivados de la práctica de la pintura, el dibujo, la escultura, entre otros; además de servir de guía y apoyo a las inquietudes artísticas de nuestros alumnos.</p>
        <h4>Objetivo</h4>
          <p class="lead text-justify">El objetivo de este taller es lograr que los niños, puedan expresar su creatividad ene el taller de pintura y dibujo a través de sus propios conociminetos, así como el conocer más acerca de las matemáticas a través del arte con técnicas y conceptos que el docente les enseñe.</p>
      </div>
    </div>
    <!-- Fin de contenidos -->
